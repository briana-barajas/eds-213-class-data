...
-- But Beware!! if you provide a filename that does not exist, 
-- DuckDB will create a new empty database with that name
...
-- What would you change to get the average snow_cover by site and year?
...
-- ============================================================
CREATE VIEW AS Site_avg_snowcover_nozeros
    SELECT Site, AVG(Snow_cover) AS avg_snow_cover FROM Snow_cover
    WHERE Snow_cover > 0
    GROUP BY Site;
...
-- ============================================================
-- join tables in order to subtract the averages
SELECT Site, Site_avg_snowcover_nozeros.avg_snowcover_nozero - Site_avg_snowcover.avg_snow_cover
    AS avg_diff
    FROM Site_avg_snowcover
    JOIN Site_avg_snowcover_nozeros USING (Site);

-- ============================================================
-- Ask 8: Which site would be the most impacted if zeros were not real zeros? 
-- Of Course we need a table for that :)
-- ============================================================
SELECT Site, Site_avg_snowcover_nozeros.avg_snowcover_nozero - Site_avg_snowcover.avg_snow_cover
    AS avg_diff
    FROM Site_avg_snowcover
...
-- We found out that actually at the location `sno05` of the site eaba, 0 means NULL... 
-- let's update our Snow_cover table
-- ============================================================
...
-- ============================================================
-- create a view of Site_avg_snowcover
